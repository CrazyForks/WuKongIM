...
使用 Rust 1.86+、Tokio 和 crates.io **WK_EASYSDK_RUST_VERSION** 完成在线收发。支持原生程序，不支持浏览器/WASM。
...
官方仓库：[WuKongIM/WuKongEasySDK-Rust](https://github.com/WuKongIM/WuKongEasySDK-Rust)。已发布 [crates.io `WK_EASYSDK_RUST_VERSION`](https://crates.io/crates/wukong-easy-sdk/WK_EASYSDK_RUST_VERSION)，需要 Rust **1.86+** 和 Tokio。使用以下精确版本：
