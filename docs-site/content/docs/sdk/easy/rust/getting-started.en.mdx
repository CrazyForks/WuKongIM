...
Use Rust 1.86+, Tokio, and crates.io **WK_EASYSDK_RUST_VERSION** for online messaging in native applications. Browser/WASM targets are not supported.
...
Official repository: [WuKongIM/WuKongEasySDK-Rust](https://github.com/WuKongIM/WuKongEasySDK-Rust). [Version `WK_EASYSDK_RUST_VERSION` is available on crates.io](https://crates.io/crates/wukong-easy-sdk/WK_EASYSDK_RUST_VERSION), requiring Rust **1.86+** and Tokio. Install the exact version below:

```toml
[dependencies]
wukong-easy-sdk = "=WK_EASYSDK_RUST_VERSION"
...
git checkout WK_EASYSDK_RUST_SOURCE_REF
