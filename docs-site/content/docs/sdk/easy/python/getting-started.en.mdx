...
Use Python 3.11+, asyncio, and PyPI **WK_EASYSDK_PYTHON_VERSION** for online messaging. Each client belongs to one event loop.
...
This tutorial uses [PyPI `wukong-easy-sdk==WK_EASYSDK_PYTHON_VERSION`](https://pypi.org/project/wukong-easy-sdk/WK_EASYSDK_PYTHON_VERSION/) and requires Python 3.11+. The distribution name is `wukong-easy-sdk`; the import name is `wukong_easy_sdk`.
