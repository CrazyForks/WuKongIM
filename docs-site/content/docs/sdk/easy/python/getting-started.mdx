...
使用 Python 3.11+、asyncio 和 PyPI **WK_EASYSDK_PYTHON_VERSION** 完成在线收发。每个客户端属于一个事件循环。
...
本文使用 [PyPI `wukong-easy-sdk==WK_EASYSDK_PYTHON_VERSION`](https://pypi.org/project/wukong-easy-sdk/WK_EASYSDK_PYTHON_VERSION/)，要求 Python 3.11+。分发名是 `wukong-easy-sdk`，导入名是 `wukong_easy_sdk`。
